    ...
    <article class="col2 pad_left1">
      ...
      <div id="jampergi">
        ...
        <?php
          ...
          <?php } ?>
        <form method="POST" action="<?php echo site_url('ubahjam/index_pp'); ?>">
      ...
      <br>
      <br>
      <form method="POST" action="<?php echo site_url('email/index_pp'); ?>">
        <?php foreach ($notifikasi as $row) { ?>
        ...
        <?php } ?>
        <button id="ingat2" type="submit" value="Kirim" class="button2">Ingatkan</button>
      </form>
    </article>
  </section>
</div>
