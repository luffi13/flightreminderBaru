...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ubah Penerbangan</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <form role="form" action="<?php echo site_url('mengelolapenerbangan/ubah_data')?>" method="POST">
                        ...
                        <?php 
                            ...
                            { ?>
                                <div class="form-group">
                                <input type="hidden" class="form-control" name="kodelama" value="<?php echo $row->KodePesawat; ?>">
                                </div>
                            <?php } ?>    
